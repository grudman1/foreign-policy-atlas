/* =====================================================================
   NON-LOADED v2 reference scaffold. Not loaded by index.html; does not
   register on window.PRESIDENTS. Holds the pre-v3 dossier/regions/outcomes
   as LEADS for the v3 re-derivation pipeline — claims here are unsourced
   and must be verified or discarded, never copied.

   Source: snapshot of data/trump.js (v2) taken at the moment the live file
   was cleaned out to a v3-only US-home entry. Original snapshot date in the
   data: May 2026 (projected timeline), baseline Jan 2025 (end of Biden).
   Schema in this file is the old v2 shape (state + delta + baseline; some
   points[] arrays end with the sentinel string "interp"). For the v3 schema
   and re-derivation rules, see CLAUDE.md and data/_example.js.

   This file declares a local `const TRUMP_V2_SCAFFOLD` and writes nothing
   to window. It is intentionally inert — adding a <script> tag for it
   would not register a president, only define a top-level const.
   ===================================================================== */

const TRUMP_V2_SCAFFOLD = {
  id: "trump",
...
TRUMP_V2_SCAFFOLD.dossier["Venezuela_note"] = {
  state:"neutral", delta:"→", region:"South America",
  baseline:"—",
